...
<div class="modal fade" id="editRolePermissionModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
                        ...
                        <div class="col-lg-12">
                            ...
                            <form action="{{ route('role-permission.updatePermission') }}" method="post"
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <table id="editPermissionListTable" class="table" data-toggle="table">
                                        <thead>
                                            <tr>
                                                <th data-field="role">
                                                    <input type="checkbox" name="allPermissions" id="allPermissions"
                                                        formName="editRolePermissionForm"> Select All
                                                </th>
                                ...
                                <div class="form-group mt-3">
                                    <button type="submit" class="btn btn-success btn-lg"
                                        id="editRolePermissionBtn">Update</button>
                                </div>
